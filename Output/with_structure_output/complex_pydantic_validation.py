...
class Review(BaseModel):
    keywords: list[str] = Field(description="all the specilied keyword within topic")
    summary: str = Field(description="a breif about the topic")
    sentiment: Literal["pos","neg"] = Field(description="return the topic sentiment")
    pros: Optional[str] = Field(description="Write down all the pros inside a list")
    cons: Optional[str] = Field(description="Write down all the cons inside a list")
    name: Optional[str]
